...
namespace Monsters
{
    ...
    class Program
    {
        ...
        static List<Monster> InitializeMonsterList()
        {
            ...
            new Monster("Bill", 30, Monster.EmotionalState.bored)
        ...
        static void WriteToDataFile(List<Monster> monsters)
        {
            ...
            {
                string monsterString = monsters[index].Name + "," + 
                                       monsters[index].Age + "," + 
        ...
        static List<Monster> ReadFromDataFile()
        {
            ...
            //
            // read from data file into array
            //
        ...
        static void DisplayMenuScreen(List<Monster> monsters)
        {
            ...
            do
            {
                ...
                Console.WriteLine("f) Filter Monster");
                ...
                switch (menuChoice)
                {
                    ...
                    case "f":
                        DisplayFilterMonsterByAttitude(monsters);
                        break;
        ...
        static void DisplayFilterMonsterByAttitude(List<Monster> monsters)
        {
            ...
            //
            // add momsters with the selected attitude to the list
